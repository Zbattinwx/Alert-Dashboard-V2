...
# WFO (Weather Forecast Office) codes and their full names
WFO_NAMES = {
    # Great Lakes Region
    ...
    "MKX": "NWS Milwaukee WI",
    "GRB": "NWS Green Bay WI",
    "DLH": "NWS Duluth MN",
    "MPX": "NWS Minneapolis MN",
    ...
    "PHI": "NWS Philadelphia PA",
    "BGM": "NWS Binghamton NY",
    "ALY": "NWS Albany NY",
    "BUF": "NWS Buffalo NY",
    "OKX": "NWS New York City NY",
    "BOX": "NWS Boston MA",
    "GYX": "NWS Gray ME",
    "CAR": "NWS Caribou ME",
    "BTV": "NWS Burlington VT",
    "RLX": "NWS Charleston WV",
    "LWX": "NWS Baltimore/Washington",
...
def get_wfo_name(office_code: str) -> str:
    """
    Get the full name for a WFO code.

    Args:
        office_code: WFO code (e.g., "CLE", "KCLE")

    Returns:
        Full office name or the code if not found
    """
    # Remove leading 'K' if present (KCLE -> CLE)
    code = office_code.upper()
    if code.startswith("K") and len(code) == 4:
        code = code[1:]

    return WFO_NAMES.get(code, f"NWS {code}")
...
class Alert:
    ...
    # Office information
    sender_office: str = ""           # WFO code (e.g., "CLE") - primary/first office
    sender_name: str = ""             # Full office name
    issuing_offices: list[str] = field(default_factory=list)  # All offices that issued this (for watches)
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "issuing_offices": self.issuing_offices,
