    ...
    <div className={`alert-detail-pane ${isOpen ? 'open' : ''}`}>
      ...
      <div className="detail-pane-content">
        ...
        <div className="detail-section">
          ...
          <div className="detail-section-content">
            {alert.sender_name || alert.sender_office || 'Unknown'}
          </div>
        </div>
          ...
          <div className="detail-section">
            ...
            <div className="detail-section-content">
              ...
              {alert.threat.snow_amount_max_inches && (
                <div>
                  <i className="fas fa-snowflake"></i> Snow: {alert.threat.snow_amount_min_inches || 0}-{alert.threat.snow_amount_max_inches}"
                </div>
              )}
              {alert.threat.ice_accumulation_inches && (
                <div>
                  <i className="fas fa-icicles"></i> Ice: {alert.threat.ice_accumulation_inches}"
                </div>
              )}
            </div>
          </div>
